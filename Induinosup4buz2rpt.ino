...
void loop() {
  ...
  for(int i12=0;i12<bd;i12++){
  
  int test=digitalRead(8);
  ...
  else if(sel==1){ digitalWrite(11, HIGH);  }
  else if(sel==2){ digitalWrite(12, HIGH); 
  digitalWrite(3, HIGH); }
  else if(sel==3){ digitalWrite(13,LOW);  }
  else if(sel==4){ digitalWrite(12, LOW);  
  digitalWrite(3, digitalRead(9));}
  else if(sel==5){ digitalWrite(11, LOW);  }
       // turn the LED on (HIGH is the voltage level)

    
  for(long i1=0;i1<xd*(1+test);i1++){
  ...
  digitalWrite(3,  digitalRead(9)) ;}
  else if(sel==5){ digitalWrite(11, LOW);  }  // turn the LED off by making the voltage LOW
    for(long i1=0;i1<random(ad-xd)/10*(1+test);i1++){
