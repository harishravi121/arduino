...
Code by Dr. Harish with LCD shield on arduino for math and recreation which can be used in calculators on brick games while reprogrammability of shop product compared to arduino product and DC power electronics are lesser in that. Can add forex also! LEDS can also be made to randomly blink like Induinosup4 but needs soldering
*/
